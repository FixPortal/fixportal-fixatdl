...
public static class ThrowHelper
{
    ...
    public static T New<T>(object? source, string message)
        where T : Exception
    {
    ...
    /// <param name="message">The message.</param>
    /// <returns>A new exception of the specified type.</returns>
    public static T New<T>(object? source, Exception innerException, string message)
        where T : Exception
    {
    ...
    public static T New<T>(object? source, string format, params object?[] args)
        where T : Exception
    {
    ...
    /// <param name="message">The message.</param>
    /// <returns>A new exception of the specified type.</returns>
    public static T New<T>(object? source, XObject? xmlNode, string message)
        where T : Exception
    {
    ...
    /// <param name="args">The args.</param>
    /// <returns>A new exception of the specified type.</returns>
    public static T New<T>(object? source, XObject? xmlNode, string format, params object?[] args)
        where T : Exception
    {
    ...
    /// </summary>
    public static T NewWithParamName<T>(object? source, string paramName, string message)
        where T : Exception
    {
        ...
        where T : Exception
    {
        ...
        ConstructorInfo classConstructor =
            classType.GetConstructor([typeof(string), typeof(Exception)])
            ?? throw new InternalErrorException(
                $"Exception type '{classType.FullName}' has no (string, Exception) constructor required by ThrowHelper. Message: {message}"
            );
